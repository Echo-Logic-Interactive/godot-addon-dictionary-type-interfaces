...
3. Set the path to your interfaces folder (default: `res://scripts/interfaces/`)

This setting is used by **SchemaExporter** to find and document your interface files for modders.
